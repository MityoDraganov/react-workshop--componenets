...
export const TableRow = ({user, setDetails, setEdit, setCreate}) =>{
    return(
      <tr>
      <td>
        <img
      ...
      <button className="btn edit-btn" title="Edit" onClick={() => setEdit(user)}>
    <svg
      aria-hidden="true"
      focusable="false"
      data-prefix="fas"
  ...
  <button className="btn info-btn" title="Info" onClick={() => setDetails(user)}>
    <svg
      aria-hidden="true"
      focusable="false"
      data-prefix="fas"
