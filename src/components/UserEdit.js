import { editOne } from "../services/UserService"

export const UserEdit = ({user, setSelect}) =>{


  const handleForm = async (e, userId) =>{
      ...
      const response = await editOne(userId, firstName, lastName, email, phoneNumber, imageUrl, country, city, street, streetNumber)
...
<div className="modal">
  <div className="user-container">
    <header className="headers">
      ...
      <button className="btn close" onClick={() => setSelect(null)}>
    ...
    <form onSubmit={(e) => handleForm(e, user._id)}>
      ...
      <div className="form-row">
        ...
        <div className="form-group">
          ...
          <div className="input-wrapper">
            ...
            <input id="streetNumber" name="streetNumber" type="text" defaultValue={user.streetNumber}/>
          </div>
          <p className="form-error">
      ...
      <div id="form-actions">
        ...
        <button id="action-cancel" className="btn" type="button" onClick={() => setSelect(null)}>
          Cancel
        </button>
      </div>
    </form>
